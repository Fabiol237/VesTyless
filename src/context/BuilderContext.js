...
export const MODULE_DEFINITIONS = {
  ...
  catalogue: {
    ...
    defaultConfig: {
      ...
      subheadline: 'Des produits sélectionnés avec soin pour une expérience premium.',
  ...
  services: {
    ...
    defaultConfig: {
      ...
      showImages: true,
      headline: 'Nos services & prestations',
      subheadline: 'Des offres claires, élégantes et adaptées à chaque besoin.',
      showGlobalCTA: true,
      globalCTAText: 'Prendre rendez-vous',
      // Pour hôtels
